...
@section('content')
                                ...
                                <div class="container">
                                    <ul class="nav nav-lb-tab" id="tab" role="tablist">
                                        <li class="nav-item ms-0" role="presentation">
                                            <a class="nav-link active " id="bookmarked-tab" data-bs-toggle="pill" href="#bookmarked" role="tab" aria-controls="bookmarked" aria-selected="true">فيديوهات</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="pb-5 py-md-5">
                                                        ...
                                                        <div class="col-lg-4 col-md-6 col-12">
                                                            ...
                                                            @if( $video  == \App\Models\Video::all()->firstOrFail())
                                                                <div class="card  mb-4 card-hover">
                                                                    <a href="#" data-id="{{ $video->id }}" data-bs-toggle="modal"
                                                                       data-bs-target="#staticBackdrop{{$video->id}}" class="card-img-top"
                                                                       data-video="{{ url(str_replace('public','storage',$video->videoCourceUrl)) }}">
                                                                        <img src="{{ asset('assets/podcastThumbnail.png') }}" alt="" class="card-img-top rounded-top-md">
                                                                    </a>
                                                                    <!-- Card body -->
                                                                    <div class="card-body">
                                                                        ...
                                                                        <ul class="mb-3 list-inline">
                                                                            <li class="list-inline-item arab">حالة :
                                                            ...
                                                            @else
                                                                <div class="card  mb-4 card-hover">
                                                                    <a href="#" data-id="{{ $video->id }}" data-bs-toggle="modal"
                                                                       data-bs-target="#staticBackdrop{{$video->id}}" class="card-img-top"
                                                                       data-video="{{ $video->videoCourceUrl }}">
                                                                        <img src="{{ asset('assets/podcastThumbnail.png') }}" alt="" class="card-img-top rounded-top-md"></a>
                                                                    <!-- Card body -->
                                                                    <div class="card-body">
                                                                        <h4 class="mb-2 text-truncate-line-2 "><a href="#" data-id="{{ $video->id }}" class="text-inherit courseTitle" data-video="{{ $video->videoCourceUrl }}">{{ $video->videoCourseTitle }}</a>
                                                                        </h4>
                                    ...
                                    <div class="row">
                                        <div class="container">
                                            <ul class="nav nav-lb-tab" id="tab" role="tablist">
                                                <li class="nav-item ms-0" role="presentation">
                                                    <a class="nav-link active " id="bookmarked-tab" data-bs-toggle="pill" href="#bookmarked" role="tab" aria-controls="bookmarked" aria-selected="true">تسجيلات صوتية</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="pb-5 py-md-5">
                                                    ...
                                                    <div class="row">
                                                        @if( \App\Models\admin\PodCast::all()->count() > 0)
                                                            @foreach(\App\Models\admin\PodCast::all() as $podcast)
                                                                <div class="col-lg-4 col-md-6 col-12">
                                                                    <div class="card  mb-4 card-hover podcastCard"
                                                                         data-podcast="{{ url(str_replace('public','storage',$podcast->podcastUrl)) }}">
                                    ...
                                    <div class="row">
                                        <div class="container">
                                            <ul class="nav nav-lb-tab" id="tab" role="tablist">
                                                <li style="direction: ltr;" class="nav-item ms-0" role="presentation">
                                                    <a class="nav-link active " id="bookmarked-tab" data-bs-toggle="pill" href="#bookmarked" role="tab" aria-controls="bookmarked" aria-selected="true">PPT مرفقات تربوية </a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="pb-5 py-md-5">
                                                        ...
                                                        @if( \App\Models\Materiels::all()->count() > 0)
                                                            @foreach( \App\Models\Materiels::all() as $mat)
                                                                <div class="col-lg-4 col-md-6 col-12">
                                                                    <!-- Card -->
                                                                    <div class="card  mb-4 card-hover ">
                                                                        <a href="#" class="card-img-top mat" data-mat="{{ url(str_replace('public','storage',$mat->file_location)) }}" ><img src="{{ asset('assets/materialsThumbnail.png')}}" alt="" class="card-img-top rounded-top-md"></a>
                                                                        <!-- Card body -->
                                                                        <div class="card-body">
    ...
    <div class="modal fade gd-example-modal-lg h-80 " id="viewMat" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title"></h5>
    ...
    <script>
        ...
        document.querySelectorAll('.mat').forEach(el => {
            el.addEventListener('click' , function (e) {
                ...
                $('#viewMat .modal-body').html(`<mat-amal src=${src}></mat-amal>`)
                $('#viewMat').modal('toggle')
            })
        })
        document.querySelector('.btn-close').addEventListener('click' , function (e) {
            e.preventDefault()
            $('#viewMat .modal-body').html('')
        })
    </script>
